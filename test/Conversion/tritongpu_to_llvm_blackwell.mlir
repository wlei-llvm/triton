...
#shared8 = #ttg.nvmma_shared<{swizzlingByteWidth = 0, transposed = false, elementBitWidth = 8}>
#shared1 = #ttg.swizzled_shared<{vec = 1, perPhase = 1, maxPhase = 1, order = [0]}>
#tmem_scales = #ttng.tensor_memory_scales_encoding<>

module attributes {tlx.enable_paired_cta_mma = true, "ttg.num-warps" = 4 : i32, "ttg.num-ctas" = 1 : i32, "ttg.threads-per-warp" = 32 : i32} {

// CHECK-LABEL: @tmem_copy_2d_paired_cta_barrier
tt.func public @tmem_copy_2d_paired_cta_barrier(%src: !ttg.memdesc<256x16xi8, #shared8, #ttg.shared_memory>,
                             %dst: !ttg.memdesc<128x32xi8, #tmem_scales, #ttng.tensor_memory, mutable>,
  ...
  // CHECK-COUNT-8: tcgen05.cp.cta_group::2.warpx4.32x128b
  // CHECK: tcgen05.commit.cta_group::2.mbarrier::arrive::one.shared::cluster.multicast::cluster.b64
  ttng.tmem_copy %src, %dst, %barrier : !ttg.memdesc<256x16xi8, #shared8, #ttg.shared_memory>, !ttg.memdesc<128x32xi8, #tmem_scales, #ttng.tensor_memory, mutable>, !ttg.memdesc<1xi64, #shared1, #ttg.shared_memory>
  tt.return
}
